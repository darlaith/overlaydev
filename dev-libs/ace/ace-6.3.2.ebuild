...
src_prepare() {
	export ACE_ROOT="${S}"
	ewarn  "Applying linux configuration to source (${ACE_ROOT}/ace/config.h)..."
	echo "#include \"ace/config-linux.h\"" > ${ACE_ROOT}/ace/config.h
	ewarn "Applying linux configuration to make (${ACE_ROOT}/include/makeinclude/platform_macros.GNU)..."
